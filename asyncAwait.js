...
console.log(`${ticket}`);
console.log("i need popcorn dear");
let popcorn=await getPopcorn;
console.log(`${popcorn}`);
console.log("i need butter dear");
let butter=await getButter;
console.log(`${butter}`);
console.log("i need cold drinks dear");
let coldDrinks=await getColdDinks;
console.log(`${coldDrinks}`);
console.log("lets go to movie dear");
